import{j as h}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./iframe-D63EGmCQ.js";import{B as A}from"./button-DEjfT9-O.js";import"./preload-helper-PPVm8Dsz.js";import"./featherIcon-C3cIBOWo.js";class C{listeners={};failed=!1;on(i,e){this.listeners[i]=this.listeners[i]||[],this.listeners[i].push(e)}trigger(i,e){(this.listeners[i]||[]).forEach(c=>{c.call(this,e)})}upload(i,e){return new Promise((f,c)=>{const a=new XMLHttpRequest;a.upload.addEventListener("loadstart",()=>{this.trigger("start")}),a.upload.addEventListener("progress",r=>{r.lengthComputable&&this.trigger("progress",{uploaded:r.loaded,total:r.total})}),a.upload.addEventListener("load",()=>{this.trigger("finish")}),a.addEventListener("error",()=>{this.trigger("error"),c()}),a.onreadystatechange=()=>{if(a.readyState==XMLHttpRequest.DONE){let r;if(a.status===200){let l=null;try{l=JSON.parse(a.responseText)}catch{l=a.responseText}let d;l&&typeof l=="object"&&l!==null&&"message"in l?d=l.message:d=l,f(d)}else if(a.status===403)r=JSON.parse(a.responseText);else{this.failed=!0;try{r=JSON.parse(a.responseText)}catch{}}if(r&&typeof r=="object"&&r!==null&&"exc"in r&&typeof r.exc=="string")try{console.error(JSON.parse(r.exc)[0])}catch{}c(r)}};const g=e.upload_endpoint||"/api/method/upload_file";a.open("POST",g,!0),a.setRequestHeader("Accept","application/json"),window.csrf_token&&window.csrf_token!=="{{ csrf_token }}"&&a.setRequestHeader("X-Frappe-CSRF-Token",window.csrf_token);const t=new FormData;if(i&&t.append("file",i,i.name),t.append("is_private",e.private?"1":"0"),t.append("folder",e.folder||"Home"),e.file_url&&t.append("file_url",e.file_url),e.doctype&&t.append("doctype",e.doctype),e.docname&&t.append("docname",e.docname),e.fieldname&&t.append("fieldname",e.fieldname),e.method&&t.append("method",e.method),e.type&&t.append("type",e.type),e.optimize&&(t.append("optimize","1"),e.max_width&&t.append("max_width",e.max_width.toString()),e.max_height&&t.append("max_height",e.max_height.toString())),e.params)for(const[r,l]of Object.entries(e.params))typeof l=="string"||l instanceof Blob?t.append(r,l):t.append(r,String(l));a.send(t)})}}const w=({fileTypes:s,uploadArgs:i,validateFile:e,children:f,onSuccess:c,onFailure:a})=>{const g=u.useRef(null),[t,r]=u.useState(null),[l,d]=u.useState(!1),[k,S]=u.useState(0),[b,q]=u.useState(0),[F,p]=u.useState(null),[x,U]=u.useState(null),[j,_]=u.useState(!1),R=b?Math.floor(k/b*100):0,T=j&&!F,E=u.useCallback(()=>{g.current?.click()},[]),N=async v=>{p(null);const o=v.target.files?.[0]||null;if(r(o),o&&e)try{const n=await e(o);if(n){p(n);return}}catch(n){n&&typeof n=="object"&&"message"in n?p(n.message||String(n)):p(String(n));return}!F&&o&&O(o)},O=v=>{p(null),S(0),q(0),_(!1);const o=new C;o.on("start",()=>d(!0)),o.on("progress",n=>{if(n&&typeof n=="object"&&n!==null&&"uploaded"in n&&"total"in n){const{uploaded:m,total:B}=n;S(m),q(B)}}),o.on("error",()=>{d(!1),p("Error Uploading File")}),o.on("finish",()=>{d(!1),_(!0)}),o.upload(v,i||{}).then(n=>{U(n),c?.(n)}).catch(n=>{d(!1);let m="Error Uploading File";if(n&&typeof n=="object"&&n!==null&&"_server_messages"in n)try{m=JSON.parse(JSON.parse(n._server_messages)[0]).message}catch{}else if(n&&typeof n=="object"&&n!==null&&"exc"in n)try{m=JSON.parse(n.exc)[0].split(`
`).slice(-2,-1)[0]}catch{}p(m),a?.(n)})};return h.jsxs("div",{children:[h.jsx("input",{ref:g,type:"file",accept:Array.isArray(s)?s.join(","):s,className:"hidden",onChange:N}),f({file:t,uploading:l,progress:R,uploaded:k,uploadedFile:x,error:F,total:b,success:T,openFileSelector:E})]})};w.__docgenInfo={description:"",methods:[],displayName:"FileUploader",props:{fileTypes:{required:!1,tsType:{name:"union",raw:"string | string[]",elements:[{name:"string"},{name:"Array",elements:[{name:"string"}],raw:"string[]"}]},description:""},uploadArgs:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  private?: boolean;
  folder?: string;
  file_url?: string;
  doctype?: string;
...
}`,...y.parameters?.docs?.source}}};const X=["Default"];export{y as Default,X as __namedExportsOrder,I as default};
